...
import com.toda.todamoon_v1.Driver.QueueingActivity;
...
public class PassengerHomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.passenger_home_fragment, container, false);
    ...
    private void openQueueingActivity(String barangayName) {
        Intent intent = new Intent(getContext(), QueueingActivity.class);
